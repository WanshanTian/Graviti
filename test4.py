...
img1 = cv2.imread("D:\download_dataset\PennFudanDatabaseForPedestrianDetectionAndSegmentation\P"
                  "ennFudanPed\PedMasks\FudanPed00004_mask.png", 0).astype("uint16")
